<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'Цены на геологические, геодезические, экологические, кадастровые работы во Владимирской области',
    'longtitle' => '',
    'description' => 'Цены на геологические, геодезические, экологические, кадастровые работы во Владимире и Владимирской области. Полный комплекс инженерных изысканий для строительства',
    'alias' => 'ceny',
    'link_attributes' => '',
    'published' => 1,
    'pub_date' => 0,
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1484300401,
    'editedby' => 1,
    'editedon' => 1504864670,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1484300520,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<meta charset="UTF-8">
	...
	<meta name="description" content="Цены на геологические, геодезические, экологические, кадастровые работы во Владимире и Владимирской области. Полный комплекс инженерных изысканий для строительства" />
 ...
 <div class="container">
	<ol itemscope itemtype="http://schema.org/BreadcrumbList" class="breadcrumps">
			  ...
			  <li itemprop="itemListElement" itemscope
                ...
                <span itemprop="name">Цены</span></a>
...
<div class="text-center"><h1 class="bordered">Цены</h1></div>
<div class="row">
<div class="col-md-8 col-md-push-2">

<h2>Цены на геологические изыскания</h2>
<!--newPRICE-->
...
<tr>
   ...
   <tr>
   	<td><a href="/#ingenerno-geologicheskie">Геологические изыскания</a> (2 скважины по 8 метров)</td>
   	<td>от 28 000</td>
   </tr>
   <tr>
...
<!--<h3>Малогабаритная буровая установка (УКБ-12-25)</h3>-->
<!--<table class="price-list">-->
<!--<tr>-->
<!--	<th>Вид работ</th>-->
<!--    <th>Цена, руб</th>-->
<!--   </tr>-->
<!--    <tr>-->
<!--       <td><strong style="color:red">Геологические изыскания для больших объектов <br>(от 40 п. м. бурения)<br> с лабораторией и разработкой отчета</strong></td>-->
...
<h2>Цены на экологические изыскания</h2>
<table class="price-list">
<tr>
	<th>Вид работ</th>
    <th>Цена, руб</th>
   ...
   <tr>
   	<td>Разработка тома ПМ ООС или М ООС</td>
   	<td>от 50 000</td>
   </tr>
   <tr>
   	<td>Инженерно-экологические изыскания для строительства</td>
   	<td>от 50 000</td>
   </tr>
...
<h2>Цены на геодезические работы</h2>
<table class="price-list">
<tr>
	<th>Вид работ</th>
    <th>Цена, руб</th>
   ...
   <tr>
   	<td>Топографическая съёмка участка</td>
   	<td>от 10 000</td>
   </tr>
   <tr>
   	<td>Съёмка фасадов зданий</td>
   	<td>от 20  000</td>
   </tr>
   <tr>
   	<td>Съёмка подземных коммуникаций</td>
   	<td>от 15 000 </td>
   </tr>
   <tr>
   	<td>Подсчёт объёмов земляных масс, сыпучих</td>
   	<td>от 18 000</td>
   </tr>
   <tr>
   	<td>Подсчёт объёмов карьеров, котлованов</td>
   	<td>от 20 000</td>
   </tr>
   <tr>
   	<td>Разбивка осей</td>
...
<h2>Цены на кадастровые работы</h2>
...
<tr>
	<td>Уточнение границ земельного участка</td>
	<td>от 15 000</td>
</tr>
<tr>
	<td>Кадастровая съёмка земельного участка с составлением кадастрового плана</td>
	<td>от 15 000</td>
</tr>
<tr>
...
<tr>
	<td>Постановка на кадастровый учет строения</td>
	<td>от 10 000</td>
</tr>
<tr>
	<td>Установка межевых знаков с бетонированием </td>
	<td>от 12 000</td>
</tr>
...
<div class="margin-block container ">
	    ...
	    <div class="text-center"><div class="h1 bordered">Получите бесплатную консультацию у нашего специалиста</div></div>
